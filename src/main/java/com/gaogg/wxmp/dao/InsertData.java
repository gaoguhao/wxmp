...
public interface InsertData {
    ...
    int insertIntoGoodsDetailOne(Long goods_id, Long cat_id, String goods_name, Long goods_price , Long goods_number, Long goods_weight, String goods_introduce, String goods_big_logo, String goods_small_logo, Long goods_state , String is_del, Long add_time , Long upd_time, String delete_time, Long hot_mumber, Boolean is_promote, Long cat_one_id , Long cat_two_id, Long cat_three_id, String goods_cat);
    ...
    int insertGoodsDetailAttrs(Long goods_id, Long attr_id, String attr_value, Long add_price, String attr_name, String attr_sel, String attr_write, String attr_vals);
}
